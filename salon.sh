...
MAIN_MENU() {
  ...
  #Don't pass paramaters to function, or the read command won't work inside it.
  BOOKSERVICE
}

BOOKSERVICE() {
  #Use the examples in examples.txt, as that is what the tests are checked against!
